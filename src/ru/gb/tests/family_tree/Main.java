package ru.gb.tests.family_tree;

import ru.gb.tests.family_tree.node.NodeCouple;
import ru.gb.tests.family_tree.operations.FamilyTree;
import ru.gb.tests.family_tree.person.Gender;
import ru.gb.tests.family_tree.person.Person;
